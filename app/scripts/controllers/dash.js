...
/**
 * @ngdoc function
 * @name dashWebclientApp.controller:MainCtrl
 * @description
 * # MainCtrl
 * Controller of the dashWebclientApp
 */


angular.module('dashWebclientApp')
  ...
  .controller('DASHCtrl', function ($scope, Sources, Notes) {
    var player,
      video,
      context,
      videoSeries = [],
